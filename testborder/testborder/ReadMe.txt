================================================================================
    MICROSOFT 基础类库： testborder 项目概述
===============================================================================

应用程序向导已为您创建了此 testborder 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 testborder 应用程序的每个文件的内容摘要。
...
testborder.h
    ...
    CtestborderApp 应用程序类。

testborder.cpp
    这是包含应用程序
    类 CtestborderApp 的主应用程序源文件。
...
testborderDoc.h、testborderDoc.cpp - 文档
    这些文件包含 CtestborderDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CtestborderDoc::Serialize）。
testborderView.h、testborderView.cpp - 文档视图
    这些文件包含 CtestborderView 类。
    CtestborderView 对象用于查看 CtestborderDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 testborder.pch 的预编译头文件 (PCH)
